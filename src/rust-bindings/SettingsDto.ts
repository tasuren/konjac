...
export type SettingsDto = { theme: ThemeSettingDto, providers: ProviderSettingsDto, model: ModelSelectionDto | null, defaultSourceLanguage: SourceLanguageSettingDto, defaultTargetLanguage: TargetLanguageSettingDto, languageListScope: LanguageListScopeSettingDto, autoDetection: AutoDetectionSettingsDto, systemPrompt: string | null, translationPrompt: string, };
